...
class PanoramaStitcher:
    def __init__(self):
        ...
        # 내부 파라미터 로드
        self.mtx_left, self.dist_left = self.load_intrinsic("camera1_intrinsic.npz")
        self.mtx_center, self.dist_center = self.load_intrinsic("camera2_intrinsic.npz")
        self.mtx_right, self.dist_right = self.load_intrinsic("camera3_intrinsic.npz")
