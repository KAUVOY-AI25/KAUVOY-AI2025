...
#define WAYPOINT "/home/kauvoyai/gps_ws/src/GPS_Package/250210_kau.txt" // waypoint.txt 경로 설정
...
bool topic_gps_datum_rcv = false, use_utm_absolute_mode = true;
...
void base_link_tf_utm(void){
	...
	tf_base_map_x = -my_pose.x; tf_base_map_y = -my_pose.y;
	tf_base_map_x += my_target_pose_goal.x; tf_base_map_y += my_target_pose_goal.y;     
...
int main(int argc, char **argv){
	...
	pose_goal.x, pose_goal.y = my_waypoints_list[wp_go_id].x, my_waypoints_list[wp_go_id].y;
