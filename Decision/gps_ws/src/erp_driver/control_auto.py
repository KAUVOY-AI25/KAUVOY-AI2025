...
class ERPHandler:
    def __init__(self, port, baudrate) -> None:
        ...
        self.speed_sub = rospy.Subscriber('/velocity', Float64, self.speed_callback)  # Subscribe to the speed topic
        self.brake_sub = rospy.Subscriber('/brake_value', Float64, self.brake_callback)  # Subscribe to the speed topic
