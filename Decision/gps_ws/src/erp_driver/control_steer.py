...
SPEED = 60 #IMPORTANT! TrackRACE = 7 km/s
STEER = 0
BRAKE = 1
ESTOP = False
GEAR = 0
...
class ERPHandler:
    def __init__(self, port, baudrate) -> None:
        ...
        self.steer_sub = rospy.Subscriber('/steering_angle', Int32, self.steer_callback)  # Subscribe to the cmd_degree topic
    ...
    def steer_callback(self, msg):
        if msg.data >= 28:
            ...
            new_steer_value = (msg.data)*(71)*0.8
...
if __name__ == "__main__":
    ...
    port, baudrate = "/dev/ttyUSB0", 115200
